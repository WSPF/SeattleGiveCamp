  ...
  */
  ...
  StyledIconTypes.MARKER = {
   ...
   StyledIconTypes.BUBBLE = {
    ...
    getURL: function(props){
      var _url = bu_ + 'd_bubble_text_small&chld=bbT|';
      _url+=props.get('text')+'|';
    ...
    getShadowURL: function(props){
      return bu_ + 'd_bubble_text_small_shadow&chld=bbT|' + props.get('text');
    },
    getAnchor: function(props,width,height){
//      return new google.maps.Point(0,42);
    return new google.maps.Point(width/2,height/2);//for bottom right anchor (bbT)	  
//    return new google.maps.Point(57,42);//specific anchor point
//    return new google.maps.Point(width-width,height-height);//for top left anchor (bbtl)
//    return new google.maps.Point(width,height-height);//for top right anchor (bbtr)
//    return new google.maps.Point(width,height);//for bottom right anchor (bbbr)
//    return new google.maps.Point(width-width,height);//for bottom left default anchor (bb)
...
//    return new google.maps.Point(width,height);//for bottom right anchor (bbbr)
    ...
    getURL: function(props){
      var _url = bu_ + 'd_bubble_text_small&chld=bbtr|';
      _url+=props.get('text')+'|';
      _url+=props.get('color').replace(/#/,'')+'|';
      _url+=props.get('fore').replace(/#/,'');
      return _url;
    ...
    getShadowURL: function(props){
      return bu_ + 'd_bubble_text_small_shadow&chld=bbtr|' + props.get('text');
    },
    getAnchor: function(props,width,height){
//      return new google.maps.Point(0,42);
...
//    return new google.maps.Point(width-width,height);//for bottom left default anchor (bb)
    ...
    getURL: function(props){
      var _url = bu_ + 'd_bubble_text_small&chld=bbtl|';
      _url+=props.get('text')+'|';
      _url+=props.get('color').replace(/#/,'')+'|';
      _url+=props.get('fore').replace(/#/,'');
      return _url;
    ...
    getShadowURL: function(props){
      return bu_ + 'd_bubble_text_small_shadow&chld=bbtl|' + props.get('text');
    },
    getAnchor: function(props,width,height){
//      return new google.maps.Point(0,42);
...
//    return new google.maps.Point(width-width,height);//for bottom left default anchor (bb)
    ...
    getURL: function(props){
      var _url = bu_ + 'd_bubble_text_small&chld=bbbr|';
      _url+=props.get('text')+'|';
      _url+=props.get('color').replace(/#/,'')+'|';
      _url+=props.get('fore').replace(/#/,'');
      return _url;
    ...
    getShadowURL: function(props){
      return bu_ + 'd_bubble_text_small_shadow&chld=bbbr|' + props.get('text');
    },
    getAnchor: function(props,width,height){
//      return new google.maps.Point(0,42);
...
//    return new google.maps.Point(57,42);//specific anchor point
//    return new google.maps.Point(width-width,height-height);//for top left anchor (bbtl)
    return new google.maps.Point(width,height);//for top right anchor (bbtr)
//    return new google.maps.Point(width,height);//for bottom right anchor (bbbr)
//    return new google.maps.Point(width-width,height);//for bottom left default anchor (bb)
