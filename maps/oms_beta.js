...
(function() {
  ...
  this['OverlappingMarkerSpiderfier'] = (function() {
    ...
    p['circleSpiralSwitchover'] = 2;

    p['circleFootSeparation'] = 30;
    ...
    function _Class(map, opts) {
      ...
      this.listeners = {};
      _ref1 = ['mouseover', 'zoom_changed', 'maptypeid_changed'];
    ...
    p['addMarker'] = function(marker) {
      ...
      marker['_oms'] = true;
      listenerRefs = [
        ge.addListener(marker, 'mouseover', function() {
    ...
    p.spiderListener = function(marker) {
      ...
      if (markerSpiderfied || this.map.getStreetView().getVisible()) {
        return this.trigger('mouseover', marker);
      } else {
        nearbyMarkerData = [];
        nonNearbyMarkers = [];
